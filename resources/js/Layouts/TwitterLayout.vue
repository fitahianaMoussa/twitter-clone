...
const getFile = (e) => {
    ...
    uploadType.value = file.value.name.slipt(".").pop();
};
...
<template>
    <div class="fixed w-full">
        <div class="max-w-[1400px] flex mx-auto">
            <div class="lg:w-3/12 h-[100vh] max-w-[350px] lg:px-4 lg:mx-auto">
            ...
            <div class="lg:w-7/12 w-11/12 border-x border-gray-800 relative">
                ...
                >
                    <div class="border-gray-800 border-b w-full">
                        ...
                        <div class="flex">
                            <div
                                class="flex items-center justify-center w-full h-[60px] text-white text-[17px] text-extrabold p-4 hover:bg-gray-500 hover:bg-opacity-30 cursor-pointer transition duration-200 ease-in-out"
                            >
                                <div
                            ...
                            <div
                                class="w-full h-[60px] text-gray-500 text-[17px] text-extrabold p-4 hover:bg-gray-500 hover:bg-opacity-30 cursor-pointer transition duration-200 ease-in-out"
                            >
                ...
                <div
                    class="absolute top-0 z-0 h-full overflow-auto srollbar-hide"
                >
                ...
                >
                    ...
                    >
                        <div class="flex p-3 justify-between h-[80px] py-3">
                            ...
                            <img class="rounded-xl" :src="randImag2" alt="" />
                        </div>
                    </div>
            ...
            <div class="w-full flex">
                ...
                <div class="w-[calc(100%-100px)]">
                    <div class="inline-block">
                        ...
                        >
                            <span
                                class="text-[#1C9CEF] p-0 pl-3.5 font-extrabold"
                                >Everyone</span
                            >
                            <ChevronDown
                                class="pr-2"
